...
export function BlockModal({ userId, userName, onClose, onBlocked }: Props) {
  ...
  const modal = (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
      ...
      onClick={onClose}>
      <div className="w-full max-w-sm rounded-2xl p-6 relative animate-slide-up"
        ...
        <p style={{ fontSize: 14, color: "var(--text-secondary)", lineHeight: 1.65, marginBottom: error ? 16 : 24 }}>
        ...
        <div className="flex gap-3">
          ...
          <button onClick={confirm} disabled={loading}
            ...
            style={{ padding: "10px 20px", fontSize: 13.5, background: "#f97316", color: "#fff", boxShadow: loading ? "none" : "0 0 16px rgba(249,115,22,0.2)" }}>

      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 py-8">
        <div className="w-full max-w-md">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={email} onChange={(e) => { setEmail(e.target.value); setError(""); }}
                  ...
                  className={`input-base pl-11 ${error ? "border-red-500/50 focus:border-red-500" : ""}`} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPassword ? "text" : "password"} value={password}
                  ...
                  className={`input-base pl-11 pr-12 ${error ? "border-red-500/50 focus:border-red-500" : ""}`} />
          ...
          <p className="text-center text-sm text-gray-400 mt-6">
            ...
            <Link href="/auth/signup" className="text-brand-400 hover:text-brand-300 font-medium">Create one free</Link>
          </p>
        </div>
      </div>
    </div>

        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="card p-6">
            <h3 className="font-semibold text-white mb-4">
              Photos
              <span className="text-gray-500 font-normal text-sm ml-2">({images.length}/6)</span>
            </h3>
          ...
          <div className="card p-6 space-y-5">
            ...
            <div>
              ...
              <div className="flex gap-2 mt-1">
                {(["active", "sold", "inactive"] as const).map((s) => (
                  <button
                    key={s}
                    type="button"
                    onClick={() => setForm({ ...form, listingStatus: s })}
              ...
              <p className="text-xs text-gray-500 mt-1.5">
                Mark as <strong className="text-blue-400">Sold</strong> when the game has been purchased, or <strong className="text-gray-400">Inactive</strong> to hide it temporarily.
              </p>
            </div>
          </div>
          ...
          {/* Preview */}
          {form.title && (
            <div className="bg-dark-800/60 border border-dark-600 rounded-xl p-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-1.5">
                    {form.platform && selectedPlatformConfig && (
          ...
          <div className="flex gap-3 pb-10">
            <Link href={`/listings/${id}`} className="btn-secondary flex-1 text-center">
              Cancel
            </Link>
            <button
              type="submit"
